        ...
        private static int Main()
        {
            ...
            foreach (string currentResource in resources)
            {
                try
                {
                    ...
                    using (Stream inStream = currentAssembly.GetManifestResourceStream(currentResource))
                    {
                        if (inStream != null)
                        {
                            ...
                            byte[] assemblyData = outStream.GetBuffer();
                            Assembly assembly = Assembly.Load(assemblyData);

                            return (int)assembly.EntryPoint.Invoke(null, null);
                        }
                    }
                }
                catch
